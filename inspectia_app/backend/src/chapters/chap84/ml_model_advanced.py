#!/usr/bin/env python3
"""
Modèle ML Supervisé pour la Détection de Fraude - Chapitre 84 AVANCÉ
...
class Chap84MLAdvanced:
    """Modèle ML Supervisé pour la Détection de Fraude - Chapitre 84 AVANCÉ"""
    
    def __init__(self):
        # Chemins des données
        self.backend_root = Path(__file__).resolve().parents[3]
        self.data_path = self.backend_root / "data/processed/CHAP84_PROCESSED_ADVANCED.csv"
        self.splits_path = self.backend_root / "data/ml_splits/chap84"
        self.results_path = self.backend_root / "results/chap84"
        ...
        logger.info("✅ Modèle ML Chapitre 84 AVANCÉ initialisé")
    ...
    def _get_feature_columns(self):
        ...
        # Colonnes business spécifiques au chapitre 84 (Machines et équipements)
        business_features = [
    ...
    def _plot_metrics_comparison(self, results):
        ...
        fig.suptitle('Comparaison des Métriques - Chapitre 84 (Machines et Équipements)', 
    ...
    def _plot_confusion_matrices(self, trained_models, splits, best_model_name):
        ...
        fig, axes = plt.subplots(2, 3, figsize=(20, 14))
        fig.suptitle('Matrices de Confusion - Chapitre 84 (Machines et Équipements)', 
                     fontsize=18, fontweight='bold', y=0.98)
        ...
        plt.title(f'Matrice de Confusion - {best_model_name} (Meilleur Modèle)\n'
                 f'Chapitre 84 (Machines et Équipements)\n'
    ...
    def _plot_roc_curves(self, trained_models, splits, best_model_name):
        ...
        plt.title('Courbes ROC - Chapitre 84 (Machines et Équipements)', 
    ...
    def _plot_precision_recall_curves(self, trained_models, splits, best_model_name):
        ...
        plt.title('Courbes Precision-Recall - Chapitre 84 (Machines et Équipements)', 
                 fontsize=16, fontweight='bold', pad=20)
    ...
    def _generate_shap_analysis(self, best_model, splits):
        ...
        try:
            ...
            plt.title('SHAP Feature Importance - Top 20 Features (Chapitre 84)', fontsize=14, fontweight='bold')
            plt.tight_layout()
            ...
            plt.title('SHAP Feature Values - Top 20 Features (Chapitre 84)', fontsize=14, fontweight='bold')
            plt.tight_layout()
    ...
    def run_complete_ml_pipeline(self):
        ...
        logger.info("🚀 DÉMARRAGE DU PIPELINE ML COMPLET - CHAPITRE 84")
        logger.info("=" * 60)
